...
// import 'package:workermanager/ori_home_screen.dart';
// import 'package:workermanager/ori_home2_screen.dart';
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                onPressed: (){
                  ...
                  getDivDocument(_emailController.text);
                  _signIn();
...
// 여기부터 추가
Future<void> getDivDocument(var em) async {
  //var sort = "";
